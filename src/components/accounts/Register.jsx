      ...
      <Box m="auto" maxWidth={"lg"} p={5} boxShadow={3} borderRadius={2}>
        <Grid item xs={12} lg={6}>
          ...
          <Typography variant="body2" color="GrayText">
            Create your new account to start managing your church information.
            We will collect some primary details about you and you will be all
            good to go!
          </Typography>
        </Grid>
        <Grid container xs={12}>
          <Grid container xs={12} lg={8} columnSpacing={2} rowSpacing={2}>
            <Grid item xs={12}>
              <TextField
                id="accountname"
            ...
            <Grid item xs={12} lg={6}>
              <TextField
                ...
                label="Phone#"
                variant="standard"
                value={formData.address ? formData.address.phone : ""}
                onChange={(e) =>
                  setFormData({
                    ...formData,
            ...
            <Grid item xs={12} lg={6}>
              <TextField
                ...
                type="password"
                onChange={(e) => {
                  setError(e.target.value !== formData.password ? true : false)
                }}
                required
                fullWidth
              />
          ...
          >
            ...
            <Typography variant="h4" color="GrayText" ml={4}>
              Pay more attention to serving the Lord and not managing the
              information.
            </Typography>
          </Grid>
        </Grid>
